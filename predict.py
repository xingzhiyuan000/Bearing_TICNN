...
if __name__ == '__main__':
    ...
    model_path = ".\models\Rope_A.pth"  # 预测模型路径
    # model_path = ".\models\Rope_B.pth"  # 预测模型路径
    #定义训练的设备
    ...
    # root = "./testset/Mine/0"  # 数据集所在根目录
    # root = "./testset/Mine/0_SNR4"  # 数据集所在根目录
    # root = "./testset/Mine/1"  # 数据集所在根目录
    # root = "./testset/Mine/1_SNR2"  # 数据集所在根目录
    # root = "./testset/Mine/1_SNR4"  # 数据集所在根目录
    # root = "./testset/Mine/2_SNR4"  # 数据集所在根目录
    # root = "./testset/Mine/3_SNR4"  # 数据集所在根目录

    # root = "./testset/IMS"  # 数据集所在根目录
    # root = "./testset/IMS_Status/Time"  # 数据集所在根目录
